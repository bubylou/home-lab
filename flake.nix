  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in {
        packages = rec {
          default = quien;
          pipeweaver = pkgs.callPackage ./packages/pipeweaver {};
        ...
        checks = {
          inherit (self.packages.${system}) pipeweaver;
        ...
        apps = rec {
          default = quien;
          pipeweaver = flake-utils.lib.mkApp {drv = self.packages.${system}.pipeweaver;};
